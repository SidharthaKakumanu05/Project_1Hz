...
def get_config():
    ...
    cfg["seed"] = 12345
    cfg["lif_IO"] = dict(C=200e-12, gL=12e-9, EL=-0.067, Vth=-0.052, Vreset=-0.070, refrac_steps=int(0.002/cfg["dt"]))
    cfg["lif_PKJ"] = dict(C=250e-12, gL=14e-9, EL=-0.068, Vth=-0.052, Vreset=-0.072, refrac_steps=int(0.002/cfg["dt"]))
    cfg["lif_BC"]  = dict(C=180e-12, gL=10e-9, EL=-0.065, Vth=-0.050, Vreset=-0.070, refrac_steps=int(0.0015/cfg["dt"]))
    cfg["lif_DCN"] = dict(C=220e-12, gL=10e-9, EL=-0.060, Vth=-0.048, Vreset=-0.062, refrac_steps=int(0.002/cfg["dt"]))
    ...
    cfg["ltd_window"] = dict(t_pre_cf=0.1)
    cfg["ltd_scale"]  = 9e-4
    cfg["ltp_window"] = dict(t_pre_cf=0.9)
    cfg["ltp_scale"]  = 1e-4
    cfg["g_gap_IO"] = 3e-9
